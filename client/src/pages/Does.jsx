    ...
    return (
        <div>
            ...
            <div className="doe25">
                <h2>Sequoia</h2>
                <h3>Paternal Parent: </h3>
                <h3>Maternal Parent: Shenandoah National Park</h3>
                <h3>Paternal Grandparents:</h3>
                <h3>Maternal Grandparents:</h3>
                <h4>Kids Living On CU@LilRedBarn Farm:</h4>
                <h4>Kids Living Off CU@LilRedBarn Farm:</h4>
            ...
            <div className="doe26">
                <h2>Pine</h2>
                <h3>Paternal Parent: </h3>
                <h3>Maternal Parent: Sequoia</h3>
                <h3>Paternal Grandparents:</h3>
                <h3>Maternal Grandparents: & Shenandoah National Park</h3>
                <h4>Kids Living On CU@LilRedBarn Farm:</h4>
                <h4>Kids Living Off CU@LilRedBarn Farm:</h4>
            </div>
            <div className="doe27">
